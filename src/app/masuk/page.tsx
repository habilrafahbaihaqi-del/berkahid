    ...
    <div className="min-h-dvh flex bg-white font-sans text-gray-900">
      ...
      <div className="hidden lg:flex w-[45%] bg-emerald-950 p-10 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 text-emerald-50 w-full max-w-sm mx-auto">
          <h2 className="text-3xl font-bold mb-1">Selamat Datang Kembali</h2>
          <h3 className="text-2xl font-bold text-emerald-400 mb-4">Lanjutkan Ibadahmu</h3>
          <p className="text-emerald-100/80 text-sm leading-relaxed mb-8">
            Masuk untuk mengakses jadwal sholat, Al-Qur&apos;an, dzikir, doa harian, dan fitur bermanfaat lainnya.
          </p>
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Selamat datang kembali. Masuk untuk <br className="hidden lg:block"/>melanjutkan ibadahmu.
            </p>
          </div>
