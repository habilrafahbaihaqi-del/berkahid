...
export const metadata: Metadata = {
  title: "Lupa Kata Sandi — BerkahID",
};
    ...
    <div className="min-h-dvh flex bg-white font-sans text-gray-900">
      ...
      <div className="hidden lg:flex w-[45%] bg-emerald-950 p-10 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 text-emerald-50 w-full max-w-sm mx-auto">
          <h2 className="text-3xl font-bold mb-1">Tenang Saja</h2>
          <h3 className="text-2xl font-bold text-emerald-400 mb-4">Kami Bantu Pulihkan Akunmu</h3>
          <p className="text-emerald-100/80 text-sm leading-relaxed mb-8">
            Jangan biarkan lupa kata sandi menghentikan niat baik ibadahmu. Kami akan mengirimkan tautan untuk mengatur ulang kata sandimu.
          </p>
        </div>
      </div>
