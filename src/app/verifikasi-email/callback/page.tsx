...
import VerificationCallbackContent from "@/components/auth/verification-callback-content";

export const metadata: Metadata = {
  title: "Verifikasi Email — BerkahID",
};
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-emerald-900 via-emerald-800 to-teal-900 text-white">
      <main className="mx-auto flex max-w-md flex-col items-center gap-6 px-6 pb-16 pt-14 text-center">
        ...
        <Suspense
          fallback={
            <p className="text-sm text-emerald-100/70">Memproses verifikasi…</p>
          }
        >
