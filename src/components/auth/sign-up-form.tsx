...
export default function SignUpForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
      <div>
        <label htmlFor="signup-email" className="text-sm font-semibold text-gray-900 mb-1.5 block">
          Email
        </label>
      ...
      <div>
        <label htmlFor="signup-password" className="text-sm font-semibold text-gray-900 mb-1.5 block">
          Kata Sandi
        </label>
        <div className="relative">
          <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-gray-400">
      ...
      <div>
        <label htmlFor="signup-confirm" className="text-sm font-semibold text-gray-900 mb-1.5 block">
      ...
      <p className="text-center text-sm text-gray-500 mt-2">
        Sudah punya akun?{" "}
        <Link href="/masuk" className="font-bold text-emerald-600 hover:text-emerald-700">
          Masuk sekarang
        </Link>
      </p>
    </form>
