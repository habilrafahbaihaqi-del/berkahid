...
const ITEMS: SidebarItem[] = [
  {
    href: "/admin/kelola-zikir",
    label: "Kelola Zikir",
    activeMatch: (pathname) => pathname.startsWith("/admin/kelola-zikir"),
    icon: (
  ...
  {
    href: "/admin/kelola-doa",
    label: "Kelola Doa",
    activeMatch: (pathname) => pathname.startsWith("/admin/kelola-doa"),
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden>
        <path
          strokeLinecap="round"
  ...
  {
    href: "/admin/kelola-cerita",
    label: "Kelola Cerita Islami",
    activeMatch: (pathname) => pathname.startsWith("/admin/kelola-cerita"),
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden>
        <path
          strokeLinecap="round"
  ...
  return (
    <div className="flex items-center gap-3 px-3 pb-6">
      ...
      <div>
        ...
        <p className="text-[10px] text-emerald-200/60">BerkahID</p>
      </div>
    </div>
  );
}
...
function AccountFooter() {
  ...
  return (
    <div className="mt-auto flex flex-col gap-2">
      <Link
        href="/dashboard"
        className="flex items-center justify-center gap-1.5 rounded-2xl bg-emerald-400/15 px-3 py-2.5 text-[11px] font-bold text-emerald-200 ring-1 ring-emerald-300/25 transition-colors hover:bg-emerald-400/25"
      >
        <svg
